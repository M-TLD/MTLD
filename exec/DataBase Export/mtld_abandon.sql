...
--
-- Table structure for table `abandon`
--

DROP TABLE IF EXISTS `abandon`;
...
--
-- Dumping data for table `abandon`
--

LOCK TABLES `abandon` WRITE;
/*!40000 ALTER TABLE `abandon` DISABLE KEYS */;
/*!40000 ALTER TABLE `abandon` ENABLE KEYS */;
UNLOCK TABLES;
