...
import AccommodationMap from 'components/location/AccommodationMap';
      ...
      <Container>
        <TitleDiv>
          <Title>
            ...
            <br />
            여행할 수 있는
            <Highlight> 숙소</Highlight>
          </Title>
          <AccommodationImg src={AccommodationLogo} />
        </TitleDiv>
        <SearchDiv>
        ...
        <AccommodationMap searchPlace={Place} flag={flag} />
      </Container>
    </div>
  );
}
